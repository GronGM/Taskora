...
const customerSteps = [
    ...
    { title: 'Выберите исполнителя и оплатите', text: 'Деньги замораживаются в безопасной сделке — исполнитель видит, что оплата есть, но получит ее только после вашей приемки.' },
...
const performerSteps = [
    ...
    { title: 'Сдайте работу', text: 'Заказчик проверяет результат в заранее известный вам срок. Деньги уже заморожены и ждут вас.' },
    { title: 'Получите оплату', text: 'После приемки сумма доступна сразу. Выполненные заказы растят ваш уровень — от Новичка до Эксперта.' },
];
    ...
    return (
        <PublicLayout>
            <Head title="Как это работает">
                <meta
                    name="description"
                    content="Как работает Таскора: безопасная сделка с заморозкой оплаты, прозрачная комиссия, споры с модератором и честные уровни исполнителей."
                />
            </Head>
            ...
            <section className="border-b border-slate-200 bg-white dark:border-slate-800 dark:bg-slate-950">
                <div className="mx-auto max-w-7xl px-4 py-14 sm:px-6 lg:px-8">
                    ...
                    <p className="mt-5 max-w-2xl text-base leading-7 text-slate-600 dark:text-slate-300">
                        Простая идея: заказчик и исполнитель договариваются внутри платформы, деньги защищены безопасной сделкой,
            ...
            <section className="mx-auto max-w-7xl px-4 py-12 sm:px-6 lg:px-8">
                ...
                <div className="mt-12 rounded-lg border border-blue-200 bg-blue-50 p-6 dark:border-blue-800 dark:bg-blue-950">
                    <h2 className="text-xl font-semibold text-slate-950 dark:text-slate-100">Безопасная сделка коротко</h2>
                    <div className="mt-4 grid gap-4 text-sm leading-6 text-slate-700 dark:text-slate-300 lg:grid-cols-3">
                        <p>
                            <span className="font-semibold">Заморозка.</span> Оплата удерживается до приемки: исполнитель уверен, что деньги есть, заказчик — что не потеряет их без результата.
                        </p>
                        <p>
                            <span className="font-semibold">Срок проверки.</span> От {reviewHold.min} до {reviewHold.max} дней, выбирает заказчик (по умолчанию {reviewHold.default}). Исполнители видят срок заранее. Ранняя приемка — мгновенная выплата.
                        </p>
                        <p>
