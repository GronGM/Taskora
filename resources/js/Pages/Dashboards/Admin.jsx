...
const cards = [
    ...
    },
    {
        ...
        description: 'Проверить текущий mailer, from-поля и признаки SMTP-настроек без вывода секретов из .env.',
    },
    {
        title: 'Пользователи',
        href: '/admin/users',
        description: 'Искать аккаунты, проверять профиль, менять роль, блокировать доступ и вести админские заметки без раскрытия паролей.',
    },
    {
