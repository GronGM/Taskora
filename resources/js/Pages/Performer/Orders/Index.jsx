                ...
                {orders.length > 0 ? (
                                ...
                                <div className="flex flex-col gap-5 lg:flex-row lg:items-start lg:justify-between">
                                    <div>
                                        ...
                                        <div className="mt-4 grid gap-3 text-sm text-slate-600 sm:grid-cols-4">
                                            <p>Заказчик: <span className="font-semibold text-slate-950">{order.participant}</span></p>
                                            <p>К выплате: <span className="font-semibold text-slate-950">{currency.format(order.performer_amount)} ₽</span></p>
                    ...
                    <div className="mt-8 rounded-lg border border-dashed border-slate-300 bg-white p-10 text-center">
                        ...
                        <p className="mt-3 text-sm leading-6 text-slate-600">
                            Заказы появятся после покупки вашей услуги или выбора вашего отклика заказчиком.
                        </p>
