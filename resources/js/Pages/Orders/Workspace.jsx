...
function hasActions(role, order) {
    if (role === 'customer') {
        return order.can.mark_paid || order.can.complete || order.can.request_revision || order.can.cancel_as_customer;
    }

    return order.can.submit_work || order.can.cancel_as_performer;
}
