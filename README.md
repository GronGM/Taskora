...
Лучший следующий этап — реализовать модераторскую очередь услуг: список услуг `pending_review`, просмотр карточки, одобрение, отклонение и отображение причины отказа исполнителю.
